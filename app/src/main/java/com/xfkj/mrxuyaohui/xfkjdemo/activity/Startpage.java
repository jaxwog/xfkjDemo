...
import com.xfkj.mrxuyaohui.xfkjdemo.WelcomeActivity;
...
public class Startpage extends Activity {
    ...
    private void goHome() {
        Intent intent = new Intent(Startpage.this, FristActivity.class);
    ...
    private void goGuide() {
        Intent intent = new Intent(Startpage.this, WelcomeActivity.class);
        startActivity(intent);
        finish();
    }
